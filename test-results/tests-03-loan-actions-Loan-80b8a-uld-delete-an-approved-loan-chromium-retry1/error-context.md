          ...
          - rowgroup [ref=e57]:
            - row "John Doe $50,000.00 36 mo 8.0% $1,500.00 approved Dec 1, 2025 Delete loan application" [ref=e58]:
              ...
              - cell "Delete loan application" [ref=e67]:
                - button "Delete loan application" [active] [ref=e68] [cursor=pointer]:
                  - generic [ref=e69]: delete
  - generic [ref=e71]:
    - heading "Delete Loan Application" [level=3] [ref=e73]
    - paragraph [ref=e75]: Are you sure you want to delete the loan application for John Doe? This action cannot be undone.
    - generic [ref=e76]:
